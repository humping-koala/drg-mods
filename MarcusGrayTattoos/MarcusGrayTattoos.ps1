...
$ProjectVersion = "1.0"
$ProjectName = "MarcusGray Tatoos" # Name of your mod
...
$SkipCooking = $true # Set to $true to prevent waste of time on cooking the project if we made binary edits only.
